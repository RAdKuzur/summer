...
<div class="party-personal-form">
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading"><h4><i class="glyphicon glyphicon-envelope"></i>Участники защиты</h4></div>
                        ...
                        <div class="item1 panel panel-default"><!-- widgetBody -->
                            ...
                            <div class="panel-body">
                                <div>
                                    ...
                                    $items = \yii\helpers\ArrayHelper::map($branch,'id','fullName');
                                    $params = [
                                        'prompt' => '',
                                    ];
                                    echo $form->field($modelPersonal, "[{$i}]personal_offset_id")->dropDownList($items,$params)->label('Участник');
                                    ?>
